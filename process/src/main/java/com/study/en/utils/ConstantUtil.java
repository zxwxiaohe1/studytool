...
public class ConstantUtil {
    ...
    public final static String SYMBOL_JOINT_MARK  = "-";
    public final static String SPLIT_WORD_MEAN_CHAR = "-&-";
    public final static String ARTICLE_EMPTY_TITLE = "00000000";
    public final static String EXPORT_SIGN_ALL_WORDS = "all words";

    /**
     * word文件模板路径
     */
    public static final String FILE_EXPORT_SUFFIX = ".doc";
    /**
     * word文件模板路径
     */
     ...
     * 单词模板
     */
    public static final String TEMPLATE_WORD ="     word=>good: adj. 好的；优良的\n                    n. 好好处；善行；\n                    adv. 好";
    /**
     * 句子模板
     */
    public static final String TEMPLATE_SENTENCE ="     sentence=>good morning\n                    早上好  ";
    /**
     * 短语模板
     */
    public static final String TEMPLATE_PHRASE ="     phrase=>be good at 在...做得好";
}
